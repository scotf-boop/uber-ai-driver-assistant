...
const I18N = {
  ...
  en:{title:"Uber AI Cloud V13 OCR Pro",subtitle:"Python 3.14 compatible · browser OCR · route AI · GPS · languages · Google Maps ready"},
  es:{title:"Uber AI Cloud V13 OCR Pro",subtitle:"Compatible con Python 3.14 · OCR en navegador · ruta AI · GPS · idiomas"},
  ko:{title:"Uber AI Cloud V13 OCR Pro",subtitle:"Python 3.14 호환 · 브라우저 OCR · 경로 AI · GPS · 다국어"}
};
